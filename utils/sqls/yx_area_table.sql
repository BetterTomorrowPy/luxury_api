...
CREATE TABLE `yx_area_table` (
  `YAT_ID` int(11) NOT NULL,				--唯一标识
  `YAT_PARENT_ID` int(11) NOT NULL,			--父节点ID
  `YAT_PATH` varchar(255) NOT NULL,	        --路径（列入北京的路径为亚洲1-中国2-北京3  数据记录为  1，2，3 ）
  `YAT_LEVEL` int(11) NOT NULL,             --级别
  `YAT_CNNAME` varchar(255) NOT NULL,       --中文名
  `YAT_ENNAME` varchar(255) NOT NULL,       --英文名
  `YAT_CNPINYIN` varchar(255) NOT NULL,     --汉语拼音
  `YAT_CODE` varchar(64) NOT NULL,          --代码
  PRIMARY KEY (`YAT_ID`)
